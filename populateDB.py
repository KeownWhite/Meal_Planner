...
for userAccountNo in range(1, (mini_min+1)):
...
for userProfileNo in range(1, (mini_min+1)):
...
for construct in range(1, (mini_min+1)):
...
for illnessDepNo in range(1, mini_min+1):
...
for kitchenNo in range(1, mini_min+1):
...
for containsInKitchen in range(1, (mini_min+1)):
    ...
    if anything_in_kitchen == False:
        ...
        for x in range(1, random_amt_of_ingredients+1):
            ...
            if random_frac == 0:
                ...
                try:
                    #cursor.execute(containsInKitchens)
                    file.write(containsInKitchens2)
                    file.write(';')
                    file.write('\n')
                except:
                    pass
                ...
                if to_be_whole_number == True:
                    if some_num == 0:
                        ...
                        try:
                            #cursor.execute(containsInKitchens)
                            file.write(containsInKitchens3)
                            file.write(';')
                            file.write('\n')
                        except:
                            pass
                        ...
                        try:
                            #cursor.execute(containsInKitchens)
                            file.write(containsInKitchens4)
                            file.write(';')
                            file.write('\n')
                        except:
                            pass
                    ...
                    if some_num == 0:
                        ...
                        try:
                            #cursor.execute(containsInKitchens)
                            file.write(containsInKitchens5)
                            file.write(';')
                            file.write('\n')
                        except:
                            pass
                        ...
                        try:
                            #cursor.execute(containsInKitchens)
                            file.write(containsInKitchens6)
                            file.write(';')
                            file.write('\n')
                        except:
                            pass
...
for recipesNo in range(1, mini_max+1):
...
count=1
for recipeNo in range(1, mini_max+1):
...
for recipeIngredNo in range(1, mini_max+1):
    random_frac = random.choice(faction_numbers)
...
for add_recipe in range(1, len(recipe_list)+1):
...
for mealNo in range(1, test_min+1):
...
for created_meals in range(1, test_min+1):
...
for consist_ofNo in range(1, test_min+1):
